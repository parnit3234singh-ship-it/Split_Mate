...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final LayoutLibraryAccessors laccForLayoutLibraryAccessors = new LayoutLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>kernel</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KernelLibraryAccessors getKernel() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKernelLibraryAccessors;
    }

    /**
     * Group of libraries at <b>layout</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public LayoutLibraryAccessors getLayout() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForLayoutLibraryAccessors;
    }
    ...
    public static class Itext7LibraryAccessors extends SubDependencyFactory {
        private final Itext7CoreLibraryAccessors laccForItext7CoreLibraryAccessors = new Itext7CoreLibraryAccessors(owner);

        public Itext7LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>itext7.core</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Itext7CoreLibraryAccessors getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForItext7CoreLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Itext7CoreLibraryAccessors extends SubDependencyFactory {

        public Itext7CoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v727</b> with <b>com.itextpdf:itext7-core</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV727() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("itext7.core.v727");
        }
    ...
    public static class ItextpdfLibraryAccessors extends SubDependencyFactory {
        private final ItextpdfItext7LibraryAccessors laccForItextpdfItext7LibraryAccessors = new ItextpdfItext7LibraryAccessors(owner);

        public ItextpdfLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kernel</b> with <b>com.itextpdf.kernel:kernel</b> coordinates and
         * with version reference <b>itextpdfKernel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKernel() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("itextpdf.kernel");
        }

        /**
         * Dependency provider for <b>layout</b> with <b>com.itextpdf.layout:layout</b> coordinates and
         * with version reference <b>itextpdfLayout</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Group of libraries at <b>itextpdf.itext7</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ItextpdfItext7LibraryAccessors getItext7() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForItextpdfItext7LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ItextpdfItext7LibraryAccessors extends SubDependencyFactory {

        public ItextpdfItext7LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.itextpdf:itext7-core</b> coordinates and
         * with version reference <b>itext7CoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("itextpdf.itext7.core");
        }
     ...
     */
    @Deprecated
    public static class KernelLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>kernel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>v727</b> with <b>com.itextpdf:kernel</b> coordinates and
         * with version reference <b>kernelVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class LayoutLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public LayoutLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>layout</b> with <b>com.itextpdf:layout</b> coordinates and
         * with version reference <b>layout</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>v727</b> with <b>com.itextpdf:layout</b> coordinates and
         * with version reference <b>layoutVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>itext7Core</b> with value <b>7.2.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>itext7CoreVersion</b> with value <b>7.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getItext7CoreVersion() { return getVersion("itext7CoreVersion"); }

        /**
         * Version alias <b>itextpdfKernel</b> with value <b>7.2.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getItextpdfKernel() { return getVersion("itextpdfKernel"); }

        /**
         * Version alias <b>itextpdfLayout</b> with value <b>7.2.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getItextpdfLayout() { return getVersion("itextpdfLayout"); }
        ...
        /**
         * Version alias <b>kernel</b> with value <b>7.2.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kernelVersion</b> with value <b>7.2.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKernelVersion() { return getVersion("kernelVersion"); }

        /**
         * Version alias <b>layout</b> with value <b>7.2.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLayout() { return getVersion("layout"); }

        /**
         * Version alias <b>layoutVersion</b> with value <b>7.2.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLayoutVersion() { return getVersion("layoutVersion"); }
